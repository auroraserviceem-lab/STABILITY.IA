              ...
              <div className="space-y-6 pt-2">
                ...
                <div className="group">
                  ...
                  <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
                    ...
                    <span className="text-gray-400 font-sans select-none text-base md:text-lg">/</span>
                    <span className="text-base md:text-lg font-bold text-[#1A1A1A] font-sans select-none">
                      +54 9 2664 37-2384
                    </span>
                  </div>
                </div>
